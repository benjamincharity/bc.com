...
> <mark>The Goal:</mark> Give our users the most power _without_ dropping the
> kitchen sink in front of them.
...
> <mark>The Idea:</mark> Cut back user input to 3 colors and programmatically
> create logical ancillary colors.
...
<small>
  <mark>Note:</mark> I will be using Sass throughout this article.
</small>
