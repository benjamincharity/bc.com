...
tags:
  ...
  - css
  - color
image: generate-safe-text-colors-with-sass.webp
readingTime: 4
---
...
> <mark>The Goal:</mark> Give our users the most power _without_ dropping the kitchen
...
> <mark>The Idea:</mark> Cut back user input to 3 colors and programmatically create
...
<small><mark>Note:</mark> I will be using Sass throughout this article.</small>
...
<mark>Lightness is defined on a vertical scale from 0 to 100 while Hue is defined on a horizontal scale from 0&deg; to 360&deg;.</mark>
