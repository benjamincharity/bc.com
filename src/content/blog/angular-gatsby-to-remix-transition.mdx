...
date: 2024-01-26
description: >-
  Transitioning from Angular 12 and GatsbyJS to Remix with Vite and PNPM. Lessons
  learned from a major framework migration to Vercel.
tags:
  - angular
  - javascript
  - remix
...
transformational. <mark>Processes like compiling and bundling, which once took
significant time, were now happening almost instantly.</mark> This improved
...
theme in my recent tech stack updates. <mark>I found PNPM's efficiency almost
startling,</mark> much like my experience with Vite. Package installation and
...
While <mark>GatsbyJS took about one and a half minutes for a build, Remix took
under 30 seconds</mark>, with Vite further reducing the initial local compile
time.
