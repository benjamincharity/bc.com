...
description: >-
  Learn how to create a custom color interpolator for more control and precision
  in your visualizations. Ideal for developers and data scientists seeking to
  en...
tags:
  - color
  - data-viz
