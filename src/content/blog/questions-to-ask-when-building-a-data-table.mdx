...
Data tables are certainly one of the most complex UI features to implement. <mark>Because of this complexity, it is very easy miss requirements and also very costly to refactor.</mark> The list of questions below has been slowly built out over many years and several data-table implementations across varying companies. It is meant to assist with the initial discovery phase and help to align the expectations of all stakeholders.
