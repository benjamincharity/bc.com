...
description: >-
  A tutorial on how to correctly set up Amazon S3 to serve gZipped, static
  assets.
tags:
  - aws
  - s3
...
Back in 2011 I decided to try hosting my personal website on [Amazon S3][aws].
...
<mark>while Amazon offers handy dropdowns with values for both `content-type`
and `content-encoding`, the options we need are not in the lists by
default.</mark> So it comes across as though those options are not valid. But,
we are rebels and don't care. (Honestly I am amazed that these options have not
been added after all this time.)
...
[so-question]:
  https://stackoverflow.com/questions/8080824/how-to-serve-gzipped-assets-from-amazon-s3/15117310#15117310
