...
date: 2015-01-27
description: >-
  Learn how to store a local copy of your premium Spotify music using
  open-source software.
tags:
  - music
image: download-spotify-tracks.webp
readingTime: 5
---

Recently I ran across a Node.js library called [Spotijay][spotijay] which
...
But this did <mark>not</mark> work for me. I had to include my username in the
call:
...
> <mark>Note:</mark> A playlist URI will be a string of random characters like
> this: `5uSLUnV6U9easnPRO4rNu3`. The only way I know of to find the URI for a
