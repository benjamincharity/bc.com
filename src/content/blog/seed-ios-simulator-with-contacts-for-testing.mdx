...
<mark>Below I have outlined how I created a 2000 contact VCard for import</mark> (heavily
...
<mark>NOTE:</mark> This library expects `n.families` and `n.givens` to contain arrays.
...
<mark>NOTE #2:</mark> For some reason, the output always seems to have `undefined` at the
