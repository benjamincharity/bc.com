...
export default function ViewToggle({
  ...
  if (!mounted) {
    ...
    return (
      <div
        className={`${sizeClasses[size]} rounded-md border border-gray-300 dark:border-gray-600 ${className}`}
      />
    );
  }
    ...
    <>
      ...
      <button
        ...
        className={`
          ...
          duration-200 hover:border-pink-300
          hover:bg-gray-100 hover:text-pink-600 focus:outline-none
          focus:ring-2 focus:ring-pink-500/50
          dark:border-gray-600 dark:text-gray-300
          dark:hover:border-pink-700 dark:hover:bg-gray-800 dark:hover:text-pink-400
          ${className}
        `}
