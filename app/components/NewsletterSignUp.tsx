...
import { ActionResponse } from '~/routes/subscribe';
      ...
      <div className="p-8">
        {!!subscribeSuccess && (
          <div className="mx-auto max-w-xl">
            ...
            <svg
              className={`mx-auto my-4 size-12 lg:size-16 ${reduceMotion ? 'animate-none' : 'animate-bounce'} text-green-600 opacity-50`}
              viewBox="0 0 24 24"
            >
              <path
        ...
        {!!subscribeError && (
          <div className="mx-auto max-w-xl text-center">
            ...
            <p className={'text-md mb-2 text-red-900'}>{subscribeError}</p>
