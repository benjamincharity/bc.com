...
summary: Drastically reduce PNG size by replacing transparent colors.
tags:
  - images
  - design
  - optimization
...
![A promotional design created using opacity](/images/blog/opacity_1.png)

However, if we replace the opacities with a sample of the color created by the opacity:

![The same design as above created without opacity](/images/blog/opacity_2.png)
