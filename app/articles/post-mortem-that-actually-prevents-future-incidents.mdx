...
- **Action completion:** >85% of high-priority action items completed within their <abbr title="Service Level Objective">SLO</abbr>. (Atlassian reports elite teams hit 85-90% completion[^11][^12].)
...
- **Action Item Completion - 60-70% vs 85%:** Industry data suggests the majority of post-mortem action items (perhaps 60-70%) go uncompleted in many orgs. By contrast, elite <abbr title="Site Reliability Engineering">SRE</abbr> teams complete >85% of their post-mortem follow-up actions[^11][^12]. This higher completion rate correlates with much lower repeat incidents. It emphasizes the importance of accountability and tracking.
