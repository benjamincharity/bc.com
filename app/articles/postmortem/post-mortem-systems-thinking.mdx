...
**This is part of the Post-Mortem series.** Read the [Executive Brief](/articles/post-mortem-executive-brief), the [Field Guide](/articles/post-mortem-field-guide), or the [Definitive Guide](/articles/post-mortem-that-actually-prevents-future-incidents) (canonical).
...
**Instead of:** "Why did Bob deploy a bug on Friday?"
**Ask:** "What testing or review process failed such that a bug made it to production? What pressures or assumptions led Bob to think deployment was safe?"

**Instead of:** "Who missed the alert?"
**Ask:** "How could our alerting system be designed so critical issues are impossible to miss?"

**Instead of:** "Why didn't Sarah follow the runbook?"
**Ask:** "What made the runbook difficult to follow? How could we make the correct path the easy path?"
