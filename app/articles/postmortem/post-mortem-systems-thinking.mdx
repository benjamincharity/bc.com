...
summary: Major incidents are like Swiss cheese, not single bullets. Learn how to shift from "who screwed up" to "how did our system allow this" and uncover the multiple contributing factors that lead to complex system failures.
tags:
  - engineering
  - systems-thinking
  - root-cause-analysis
...
Studies show that even experienced investigators can be led astray by their preconceived theories. They seek evidence to fit a favorite hypothesis and overlook contrary facts.[⁹](/articles/post-mortem-that-actually-prevents-future-incidents#user-content-fn-9) In practice, this means a post-mortem might pin the cause on an easy scapegoat when reality involves multiple contributing factors.

Dave Zwieback points out that **hindsight and blame create a "comfortable story" that satisfies our need for closure but prevents real learning**.[⁷](/articles/post-mortem-that-actually-prevents-future-incidents#user-content-fn-7) We prematurely decide "Susan deployed bad code, that's the root cause," and stop analyzing deeper systemic issues.
...
As Dave Zwieback puts it: **"Human error is a symptom, never the cause, of deeper trouble in the system."**[⁷](/articles/post-mortem-that-actually-prevents-future-incidents#user-content-fn-7) If someone made a mistake, ask what made that mistake possible and how the system could catch or prevent it.

## Learning from Aviation's Transformation

The aviation industry provides a powerful example of systems thinking in action. Aviation achieved a 95%+ incident reporting rate and dramatically reduced accidents by adopting a systemic, non-blame approach.[²²](/articles/post-mortem-that-actually-prevents-future-incidents#user-content-fn-22)

Through programs like NASA's Aviation Safety Reporting System, pilots receive immunity when they voluntarily report errors or near-misses. This created an enormous database of systemic issues and fixes. The result: aviation's fatal accident rate kept dropping despite increasing complexity.[²²](/articles/post-mortem-that-actually-prevents-future-incidents#user-content-fn-22)
...
By understanding how failures propagate through your system, you can design resilience that actually improves under stress. Companies like Netflix have embraced this through chaos engineering.[¹⁷](/articles/post-mortem-that-actually-prevents-future-incidents#user-content-fn-17)

## Your Implementation Checklist

1. **Modify your post-mortem template** to include a "Contributing Factors" section (plural)
...
> **Want the definitive framework?** Read the [Definitive Guide](/articles/post-mortem-that-actually-prevents-future-incidents) for detailed implementation steps, aviation case studies, and structured analysis templates.
