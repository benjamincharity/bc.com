...
<p className="codepen" data-height="300" data-default-tab="js,result" data-slug-hash="rvMYMX" data-user="benjamincharity" style="{{height: 300px, box-sizing: border-box, display: flex, align-items: center, justify-content: center, border: 2px solid, margin: 1em 0, padding: 1em}}">
  <span>See the Pen <a href="https://codepen.io/benjamincharity/pen/rvMYMX">
