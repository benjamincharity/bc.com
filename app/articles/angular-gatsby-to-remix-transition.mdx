---
title: 'Rewriting the Tech Stack: Transitioning from Angular 12 and GatsbyJS to Remix'
summary: "I'll share my experience transitioning a web project from Angular 12 and GatsbyJS to Remix, using Vite and PNPM, and moving from Netlify to Vercel. Discover lessons learned in modern web development."
tags:
  - angular
  - javascript
  - remix
...
readingTime: 8
images: ['angular-to-remix-1_uv4kpd.jpg']
draft: true
---

I initially developed this website using Angular 12 and GatsbyJS. However, I have recently switched to Remix. I aimed to enhance my development experience and increase the frequency of publishing my articles while also improving the overall quality of my website. In this article, I will explain the reasons behind this decision, the process involved in the transition, and the valuable insights I gained from the experience.

![Isometric concept art of a programming workflow with interconnected devices and screens displaying code and data management tools on a blue background.](angular-to-remix-1_uv4kpd.jpg)
...
![Isometric graphic of a software development lifecycle with package managers, version control, and programming tools ascending along a growth arrow in yellow and blue tones.](angular-to-remix-2_agoerm.jpg)
...
In my career, I have used NPM in the first half and Yarn in the second half, witnessing the evolution of package management in the JavaScript ecosystem. PNPM stood out not only because of its speed but also because of its familiar command structure. This familiarity made the transition feel less like learning a new tool and more like upgrading to a better version of an old one.
...
My previous website was static, but I wanted to work with server-side rendering (SSR) in a single-page application (SPA). After hearing about RemixJS and its robustness in a React-based ecosystem, I decided to use it.

At first, I was skeptical about SSR, but RemixJS helped me appreciate its benefits. The framework's implementation of SSR was particularly impressive in terms of performance and user experience, especially for sites with rich content.

In the past, I had used API caching to improve persistence and offline functionality. RemixJS complemented this experience by enhancing the initial data delivery, making it more efficient even when connectivity was limited.

Choosing RemixJS for my first deep dive into SSR wasn't just about trying out a new technology. It represented a significant step in my development practice, where I embraced a more integrated approach, balancing server-side efficiency with a dynamic front-end experience.
...
With SSR, the approach to data delivery is fundamentally different. Loading initial data is not only a matter of client-side requests but also involves a server-side process that was new territory for me. This shift was not just a technical transition but a conceptual one, requiring me to rethink the strategies I had previously accustomed to in a purely SPA context. RemixJS, therefore, was not just a tool but a new paradigm for managing data and UI performance.
...
![Isometric digital illustration of a multilayered data center with cloud computing icons, data blocks, and connectivity symbols in a blue color scheme.](angular-to-remix-3_nt6pcf.jpg)
