...
summary: Small design tweaks can positively affect how users feel on your site.
tags:
  - css
  - design
  - ui
...
![A website screenshot shows text that reaches from the left to the right, touching both sides.](padding_iojmyt.jpg)
...
![A website screenshot shows text that reaches from the left to the right, with comfortable spacing on each side.](padding02_ciqekv.jpg)
