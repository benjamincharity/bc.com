...
summary: Create a visual timeline of your year with automatic pictures taken after each commit.
tags:
  - git
publishDate: 2014-12-30
readingTime: 3
images: ['git-commits-year-in-review.jpg']
---

![A solitary figure looking into the foggy expanse, symbolizing introspection and the contemplative journey through the past year.](git-commits-year-in-review.jpg)

A few years back I saw a post by someone where they created a video by capturing a picture from their webcam each day
...
![Short example from my gitshot year in review](/images/blog/2014_gitshots.gif)
