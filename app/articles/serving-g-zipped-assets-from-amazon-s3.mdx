...
summary: A tutorial on how to correctly set up Amazon S3 to serve gZipped, static assets.
tags:
  - aws
  - s3
  - gzip
...
![Fred Jones ready to unmask a villain](/images/blog/unmasking.jpg)
...
![Fred Jones solves the case](/images/blog/unmasked.jpg)
...
![Open the metadata section](/images/blog/metadata.jpg)
