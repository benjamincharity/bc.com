...
summary:
  A short look at the terminology around sign-ups and logging in and the basic
  arguments for each.
tags:
  - ux
  - design
...
readingTime: 1
images: ['log-in-vs-login-vs-sign-in.jpg']
---
...
![An arrow etched into a concrete wall painted white.](log-in-vs-login-vs-sign-in.jpg)
